...
/** 查看后端服务组列表 */
public class CtelbListVmPoolApi {
    private final CtyunRequestTemplate template;
    private final CtyunClient client;

    public CtelbListVmPoolApi(CtyunClient client) {
        this.client = client;
        this.template =
                new CtyunRequestTemplate(
                        ENDPOINT_NAME, "GET", "/v4/elb/list-vm-pool", "application/json");
    }
     ...
     */
    public ListVmPoolResponse send(Credential credential, ListVmPoolRequest request)
        ...
        return response.parse(ListVmPoolResponse.class);
    }

    public static class ListVmPoolRequest {
        /** 区域ID */
    ...
    public static class ListVmPoolResponse {
        /** 返回状态码（800为成功，900为失败） */
        ...
        private List<ListVmPoolReturnObjResponse> returnObj;
        ...
        public List<ListVmPoolReturnObjResponse> getReturnObj() {
            return this.returnObj;
        }

        public void setReturnObj(List<ListVmPoolReturnObjResponse> returnObj) {
            this.returnObj = returnObj;
        }
    }

    public static class ListVmPoolReturnObjResponse {
        /** 区域ID */
        @JsonProperty("regionID")
        private String regionID;
        ...
        private List<ListVmPoolReturnObjSessionStickyResponse> sessionSticky;
        ...
        public List<ListVmPoolReturnObjSessionStickyResponse> getSessionSticky() {
            return this.sessionSticky;
        }

        public void setSessionSticky(List<ListVmPoolReturnObjSessionStickyResponse> sessionSticky) {
    ...
    public static class ListVmPoolReturnObjSessionStickyResponse {
        /** 会话保持模式 */
