...
/** 更新访问控制策略 */
public class CtelbUpdateAccessControlApi {
    private final CtyunRequestTemplate template;
    private final CtyunClient client;

    public CtelbUpdateAccessControlApi(CtyunClient client) {
        this.client = client;
        this.template =
                new CtyunRequestTemplate(
                        ENDPOINT_NAME, "POST", "/v4/elb/update-access-control", "application/json");
    }
     ...
     */
    public UpdateAccessControlResponse send(
            Credential credential, UpdateAccessControlRequest request)
        ...
        return response.parse(UpdateAccessControlResponse.class);
    }
    ...
    public static class UpdateAccessControlResponse {
        /** 返回状态码（800为成功，900为失败） */
